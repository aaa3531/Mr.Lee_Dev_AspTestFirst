...
<%       
  ...
  strSQL = "p_sh_game_betting_follower_item_list '" & Session("member_no") & "','" & yyyymmdd & "'"
  'response.write strSQL
  'response.End
...
<td width=670 valign=top>  
    ...
    <td width="20%" align="center" style="border-right:dotted 1px #ffffff;color:#ffffff;">종목1</td>  
    <td width="20%" align="center" style="border-right:dotted 1px #ffffff;color:#ffffff;">종목2</td>  
    ...
    <td width="20%" align="center" style="border-right:dotted 1px #ffffff;color:#ffffff;">배당금</td>
    </tr>
    ...
    <%=rsData("stock_name1") %><br /><%=rsData("dividend_rate1") %>
    </td>    
    <td align="center">
    <%=rsData("stock_name2") %><br /><%=rsData("dividend_rate2") %>
    </td>
    <% else %>    
    <td align="center" >
    <%=rsData("stock_name1") %><br /><%=rsData("dividend_rate1") %>
	...
	<% else %>
	<tr height="55" >
    <td width="60" align="center" colspan="7">베팅이 없습니다.</td>
    </tr>
    <% end if         
    set rsData = nothing
    %>        
