...
<%
   ...
   'response.write yyyymmdd
   
  'tr_list 읽기
  strSQL = "p_sh_stock_history_admin_yyyymmdd  '"& market_cd &"'"
  ...
  '주가읽기
  strSQL = "p_sh_stock_history_admin_list '" & yyyymmdd & "', '" & market_cd & "'"
...
<div style="padding:10px;text-align:center;">
  ...
  <div style="padding:5px;text-align:center;font-weight:bold;background-color:#ffffff;border-bottom:dotted 1px #888888;">거래시각</div>
        ...
        <% Do While Not rsHistory.EOF %>
           ...
           <SPAN style="font-weight:bold;color:#ffffff;"><%=rsHistory("yyyymmdd") %></SPAN>
               <a href="stock_history.asp?yyyymmdd=<%=rsHistory("yyyymmdd") %>&market_cd=KOSDAQ"><span class="linkbtn">코스닥</span></a>
               <a href="stock_history.asp?yyyymmdd=<%=rsHistory("yyyymmdd") %>&market_cd=KOSPI"><span class="linkbtn">코스피</span></a>
           </div>  
           <% else %>
  ...
  <td width=530 valign=top>
    ...
    <td width="25%" align="center" style="border-right:dotted 1px #ffffff;">종목명</td>  
    <td width="15%" align="center" style="border-right:dotted 1px #ffffff;">코드</td> 
    <td width="15%" align="center" style="border-right:dotted 1px #ffffff;">현재가</td>    
    <td width="15%"  align="center" style="border-right:dotted 1px #ffffff;">변동폭</td>   
    <td width="15%"  align="center" style="border-right:dotted 1px #ffffff;">등락구분</td>
    <td width="15%"  align="center" style="border-right:dotted 1px #ffffff;">등락율</td>   
    </tr>
    <% if NoDataList = False then ' 데이터가 있으면 데이터 출력 %>
    <% 
       Do While Not rsList.EOF    %> 
    <tr height="25" style="border-bottom:dotted 1px #dddddd;">   
    <td align="left"><%=rsList("stock_name") %></td>  
    <td align="center"><%=rsList("stock_cd") %></td>  
    <td align="center"><%=rsList("now_price") %></td>  
