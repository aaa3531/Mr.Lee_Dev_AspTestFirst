...
<!-- #include virtual="/_include/guide_admin_stocknew.inc" -->
  ...
  <% end if %>
    ...
    <table cellpadding=0 cellspacing=0 border=0>
          ...
          <td width="60" align="center">시장</td>
          <td width="80" align="center"><a href="default.asp?key=CODE">종목코드</a></td>
          <td width="160" align="center"><a href="default.asp?key=NAME">종목명</a></td>
          <td width="160" align="center">회사명</td>
          <td width="134" align="center">총주식/변동값</td>
          <td width="100"  align="center">로고</td>
          <td width="60" align="center">로고설정</td>
          </tr>
        ...
        <% if FirstPage <> 1 then
          ...
          <span style="font-weight:bold;color:#3388cc;"><%=rsStock("stock_name") %></span>
          </a>
          </td>
          <td >
          ...
          <td align="center">
          <%=rsStock("stock_cnt") %> / <%=rsStock("price_variance") %>
          </td>
          <td  align="center">
