...
<!-- #include virtual="/_include/guide_admin_game.inc" -->
  ...
  <div style="padding:5px;text-align:center;line-height:250%;">
    <a href="theme_game_insert.asp"><input   type="button" value="매치생성"></a>
  </div> 
    ...
    <table cellSpacing="0" cellPadding="0" border="0" ID="Table3" width="100%">
        ...
        <a href="theme_game.asp?game_no=<%=rsGame("game_no") %>"><span style="font-weight:bold;color:#3388cc;"><%=rsGame("game_no") %></span></a>
        </div>
        </td>
        ...
        <td width="25%" align="center">
        <a href="theme_game_insert.asp?yyyymmdd=<%=rsGame("yyyymmdd") %>"><input   type="button" value="매치생성"></a>
        </td>
        </tr>
        <%                                
        	rsGame.MoveNext
  ...
  <% if game_no > "0" then %>
    ...
    <form action="theme_game_update.asp" id="form3" name="formTool" method="post">
    ...
    <% end if %>
    <input id="submit1" name="submit1" type="submit" value="매치수정">
    </form>
    </div>
