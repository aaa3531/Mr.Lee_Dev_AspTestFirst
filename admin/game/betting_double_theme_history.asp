...
<%       
 ...
 ' response.End
  ...
  strSQL = "p_sh_game_betting_double_theme_list '" & yyyymmdd & "' "
  'response.write strSQL
  'response.End
...
<!-- #include virtual="/_include/guide_admin_game.inc" -->
  ...
  <td width=84 valign=top>
    ...
    <td width="40%" align="center" style="border-right:dotted 1px #ffffff; color:#ffffff;">게임일</td>   
        ...
        <a href="betting_double_theme_history.asp?yyyymmdd=<%=rsYyyymmdd("yyyymmdd") %>">
...
<td width=670 valign=top>  
    ...
    <td width="20%" align="center" style="border-right:dotted 1px #ffffff;color:#ffffff;">테마명1</td>
    <td width="20%" align="center" style="border-right:dotted 1px #ffffff;color:#ffffff;">테마명2</td>  
    <td width="10%" align="center" style="border-right:dotted 1px #ffffff;color:#ffffff;">배당률</td>
    <td width="15%" align="center" style="border-right:dotted 1px #ffffff;color:#ffffff;">베팅금</td>     
    ...
    <td align="center">
    <% if rsData("win_flag") = "1" then %>승
    <% elseif rsData("win_flag") = "0" then %>패
    <% else %>패
    <% end if %>
    </td>
