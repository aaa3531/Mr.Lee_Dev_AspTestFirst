...
<div class="admintitle">▣ ADMIN - 회원관리</div>
  ...
  <% if member_no > "0" then %>
    ...
    <td width="30%" align=center>마진율
    <input type="text" name="margin_rate" style="width:60px;" class="input" ID="Text1" value="<%=margin_rate %>" >
    </td>
    <td width="15%">
    <% if b2b_flag="1" then %>
    <input type="checkbox" name="b2b_flag" ID="Checkbox2" value="1" checked >B2B승급
    <% else %>
    <input type="checkbox" name="b2b_flag" ID="Checkbox3" value="1">B2B승급
    <% end if %>
    </td>
    <td width="15%">
  ...
  <% end if %>
    ...
    <td width="20%"  align="center" style="border-right:dotted 1px #ffffff;">계좌번호</td>    
    <td width="10%"  align="center" style="border-right:dotted 1px #ffffff;">예금주명</td>    
    <td width="10%"  align="center" style="border-right:dotted 1px #ffffff;">마진율</td>   
    <td width="10%"  align="center" style="border-right:dotted 1px #ffffff;">은행명</td>     
    <td width="10%"  align="center" style="border-right:dotted 1px #ffffff;">환전비밀번호</td>    
    <td width="10%"  align="center" style="border-right:dotted 1px #ffffff;">관리자,B2B</td>    
    </tr>
