...
<%
  ...
  if request("terms_no") = "" then	
    ...
    strSQL = "p_sm_private_policy_detail '" & terms_no & "' "
  ...
  ' terms 읽기
  strSQL = "p_sm_private_policy_list "
...
<!-- #include virtual="/_include/guide_admin_site.inc" -->
  ...
  <% if terms_no > "0" then %>
    <form action="private_policy_update.asp" id="formTool" name="formTool" method="post">
    ...
    <a href="private_policy.asp">[NEW]</a>
  ...
  <% else %>
    <form action="private_policy_insert.asp" id="form1" name="formTool" method="post">
  ...
  <% end if %>
    ...
    <table width="100%" cellpadding=0 cellspacing=0 border=0>
        ...
        <% if FirstPage <> 1 then
          ...
          <a href="private_policy.asp?page=<%=cPage%>&terms_no=<%=rsTerms("terms_no") %>"><%=rsTerms("terms_desc") %></a>
          </td>
          <td width="20%" align="center">
          <a href="private_policy.asp?page=<%=cPage%>&terms_no=<%=rsTerms("terms_no") %>"><%=rsTerms("terms_version") %></a>
          </td>
          <td width="15%" align="center">
          <%=rsTerms("start_date") %>
          </td>
          ...
          <td width="20%" align="center">
          <a href="private_policy_detail.asp?terms_no=<%=rsTerms("terms_no") %>"><span class="linkbtn">작성</span></a>
          &nbsp;<a href="private_policy_delete.asp?page=<%=cPage%>&terms_no=<%=rsTerms("terms_no") %>"><span class="linkbtn">삭제</span></a>
          </td>
          </tr>
          <% else %>
...
<%
	Response.Write ShowPageBar("private_policy.asp", Cus_pageSize, totalRecord, cPage, "/images/btn_board_pre.gif","/images/btn_board_next.gif",Cus_Tar)
%>
					</td>
				</tr>
			</table>
