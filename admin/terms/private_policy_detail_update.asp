...
<%   
  ...
  detail_desc = Replace(detail_desc, "display:none", "")
    ...
    strSQL = "p_sm_private_policy_detail_update '"    & request("detail_no") & "','" & _
                                               section_desc & "','" & _
                                               detail_desc & "','" & _
                                               request("order_seq") & "'"
    ...
    Response.redirect "private_policy_detail.asp?terms_no="&request("terms_no") & "&detail_no="&request("detail_no")
