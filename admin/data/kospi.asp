...
<!-- #include virtual="/_include/guide_admin_site.inc" -->
    ...
    <td width="10%"  align="center" style="border-right:dotted 1px #ffffff;">F7</td>    
    ...
    <td width="10%"  align="center" style="border-right:dotted 1px #ffffff;">거래비중</td>    
