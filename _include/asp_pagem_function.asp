...
Public Function ShowPageBar(ByVal pUrl, ByVal pPageSize, ByVal pTotalList, ByVal pCurPage, ByVal pPreImg, ByVal pNextImg, ByVal param)
    ...
    If pPreImg = "" Then
        pPreImg = "<font style='color:#FF0000;font-size:3.5em;font-weight:normal;'>[이전]</font>"
    Else
        pPreImg = "<img src='" & pPreImg & "' height=36 border=0 align=absmiddle>"
    End If
    
    If pNextImg = "" Then
        pNextImg = "<font style='color:#FF0000;font-size:3.5em;font-weight:normal;'>[다음]</font>"
    Else
        pNextImg = "<img src='" & pNextImg & "' height=36 border=0 align=absmiddle> "
    End If
    ...
    Do While i < Fix(nGSize+1) And nCUR <= nPageCount
        If nCUR = nPageCount Or i = nGSize Then
            pageKubun = " "
        Else
            pageKubun = "<font style='color:#dddddd;font-size:3.5em;font-weight:normal;'> | </font>"
        End If
        
        If CInt(pCurPage) = CInt(nCUR) Then
            retVal = retVal & "<font style='color:#FF0000;font-size:3.5em;font-weight:normal;'>" & nCUR & "</font>" & pageKubun
        Else
            strLink = purl & "?page=" & nCUR & "&" & param
            retVal = retVal & "<a href=""" & strLink & """><font style='color:#000000;font-size:3.5em;font-weight:normal;'>" & nCUR & "</font></a>" & pageKubun
        End If
        nCUR = nCUR + 1
        i = i + 1
    Loop
